...
public:
  ...
  Frame(int offset, int max_outgo_args, temp::Label *name,
        std::list<Access *> *formals)
      : offset_(offset), max_outgo_args_(max_outgo_args), name_(name),
        formals_(formals) {}
  ...
  [[nodiscard]] virtual std::list<Access *> *Formals() const = 0;
