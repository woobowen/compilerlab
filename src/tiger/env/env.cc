...
void ProgTr::FillBaseVEnv() {
  ...
  venv_->Enter(sym::Symbol::UniqueSymbol("flush"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("flush"), new type::TyList(),
                                 type::VoidTy::Instance()));
  ...
  venv_->Enter(
      sym::Symbol::UniqueSymbol("exit"),
      new env::FunEntry(level, temp::LabelFactory::NamedLabel("exit"), formals, type::VoidTy::Instance()));

  result = type::StringTy::Instance();

  venv_->Enter(sym::Symbol::UniqueSymbol("chr"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("chr"), formals, result));

  venv_->Enter(sym::Symbol::UniqueSymbol("getchar"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("getchar"), new type::TyList(), result));

  formals = new type::TyList(type::StringTy::Instance());

  venv_->Enter(
      sym::Symbol::UniqueSymbol("print"),
      new env::FunEntry(level, temp::LabelFactory::NamedLabel("print"), formals, type::VoidTy::Instance()));
  venv_->Enter(sym::Symbol::UniqueSymbol("printi"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("printi"),
                                 new type::TyList(type::IntTy::Instance()),
                                 type::VoidTy::Instance()));

  result = type::IntTy::Instance();
  venv_->Enter(sym::Symbol::UniqueSymbol("ord"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("ord"), formals, result));

  venv_->Enter(sym::Symbol::UniqueSymbol("size"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("size"), formals, result));

  result = type::StringTy::Instance();
  formals = new type::TyList(
      {type::StringTy::Instance(), type::StringTy::Instance()});
  venv_->Enter(sym::Symbol::UniqueSymbol("concat"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("concat"), formals, result));

  formals =
      new type::TyList({type::StringTy::Instance(), type::IntTy::Instance(),
                        type::IntTy::Instance()});
  venv_->Enter(sym::Symbol::UniqueSymbol("substring"),
               new env::FunEntry(level, temp::LabelFactory::NamedLabel("substring"), formals, result));
