...
public:
  ...
  explicit ExpStm(Exp *expr) : exp_(expr) {}
  ~ExpStm() override;
...
public:
  ...
  explicit MemExp(Exp *expr) : exp_(expr) {}
  ~MemExp() override;
...
public:
  ...
  EseqExp(Stm *stmt, Exp *expr) : stm_(stmt), exp_(expr) {}
  ~EseqExp() override;
...
public:
  ...
  void Append(Exp *expr) { exp_list_.push_back(expr); }
  void Insert(Exp *expr) { exp_list_.push_front(expr); }
